...
export default function Projects() {
  return (
    <section id="projects" className="py-28 px-6 bg-[#FEFCE8]">
      <div className="max-w-5xl mx-auto">
        ...
        <motion.h2
          ...
          Our <span className="text-[#ACC6A8]">Projects</span>
        </motion.h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {projects.map(({ title, location, panels, capacity, saving }, i) => (
            <motion.div
              ...
              whileHover={{ y: -6 }}
              className="bg-[#EEF0D8] border border-[#ACC6A8]/30 p-8 cursor-default">

              {/* Placeholder image */}
              <div className="w-full h-40 bg-[#ACC6A8]/20 flex items-center justify-center mb-6 text-5xl">
                ☀️
              </div>
