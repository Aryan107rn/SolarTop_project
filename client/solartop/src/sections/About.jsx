...
export default function About() {
  return (
    <section id="about" className="py-28 px-6 bg-[#FAEDCB]">
      <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
        ...
        <motion.div
          ...
          <a href="#contact" className="bg-[#ACC6A8] text-[#1a2e1a] font-bold text-sm tracking-widest uppercase px-8 py-3 hover:bg-[#F4B663] transition-colors inline-block">
            Work With Us
          </a>
        </motion.div>
        ...
        <motion.div
          ...
          {[
            ...
            <motion.div
              ...
              className="flex gap-4 items-start bg-[#FEFCE8] border border-[#ACC6A8]/30 p-5">
              <span className="text-2xl">{icon}</span>
              <div>
                <h4 className="font-black uppercase text-[#1a2e1a] mb-1">{title}</h4>
